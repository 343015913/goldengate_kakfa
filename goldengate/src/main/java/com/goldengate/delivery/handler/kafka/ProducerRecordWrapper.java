...
public class ProducerRecordWrapper {
	final private static Logger logger = LoggerFactory
			.getLogger(ProducerRecordWrapper.class);
	...
	public ProducerRecordWrapper(String topic, byte[] key, byte[] payload)
		...
		try {
			...
			// avro serialization can throw AvroRuntimeException,
			// NullPointerException,
			// ClassCastException, etc
			// TODO Throw a diffrent expection
			throw new SerializationException("Error serializing Avro message",
					e);
		}
	}

	public ProducerRecordWrapper(String topic, String payload) {
		this(topic, null, payload.getBytes());
