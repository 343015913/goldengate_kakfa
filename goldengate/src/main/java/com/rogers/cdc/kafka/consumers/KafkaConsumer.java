...
public abstract class KafkaConsumer<Val> {
	...
	public KafkaConsumer(final String topic, final String zkConnect, final String groupId, Decoder<Val> decoder){
         ...
         //TODO: This would probably be cleaner in scala....could just use implict params 
	...
	public void start(){
        ...
        while (it.hasNext()){
          try {
             ...
             //System.out.println("Consumer got: " + new String(msg));
             logger.debug("Consumer got: " + msg.toString());
             procEvent(msg);
          }catch (Exception e){
